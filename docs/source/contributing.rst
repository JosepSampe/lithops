...
- **Questions and ideas:** use `GitHub Discussions <https://github.com/lithops-cloud/lithops/discussions>`_
  for usage questions, design discussions and feature ideas.
- **Bugs:** open a `GitHub issue <https://github.com/lithops-cloud/lithops/issues>`_ with the bug
...
- **Security issues:** do **not** open a public issue, see
  `SECURITY.md <https://github.com/lithops-cloud/lithops/blob/master/SECURITY.md>`_.
...
most changes. To work on a cloud backend, configure it as described in
:doc:`configuration`.
...
Sphinx; see `docs/README.md <https://github.com/lithops-cloud/lithops/blob/master/docs/README.md>`_ for how to build it locally. Update it
together with any user-visible change.
...
to `CHANGELOG.md <https://github.com/lithops-cloud/lithops/blob/master/CHANGELOG.md>`_, under the
topmost (development) version, in the *Added*, *Changed*, *Fixed* or *Removed* section, prefixed
with the component. Docs fixes, packaging metadata and repository tooling need no entry, since
...
Releases are made by the `Release workflow <https://github.com/lithops-cloud/lithops/blob/master/.github/workflows/release.yml>`_:
...
`AGENTS.md <https://github.com/lithops-cloud/lithops/blob/master/AGENTS.md>`_. Contributions made with their help follow the same rules as any
other: you are responsible for reviewing, testing and understanding the code you submit.
...
`Apache License 2.0 <https://github.com/lithops-cloud/lithops/blob/master/LICENSE>`_.
